...
void buildScene()
{
	if (shapes.size() == 0)
	{
		...
		shapes.push_back(dynamic_cast<Shape*>(new PSphere(Vec(400, 400, 300), 200, Color(100, 100, 0))));
		...
		{
			Vec off { size*2 * i, 700.0, 15 }; ///Had to alter offset in Z to make triangles render properly
